  ...
  return (
    <header className="flex items-center justify-between px-32 py-6 border-b bg-neutral-800 border-zinc-600 text-slate-200">
      ...
      <div className="flex gap-3">
        <button className="flex items-center gap-2 px-2 py-1 text-sm border rounded-md border-zinc-600">
          @mario123
        ...
        <button
          ...
          disabled={isLoading}
          className="flex items-center gap-2 px-2 py-1 text-sm border rounded-md border-zinc-600">
          Logout
